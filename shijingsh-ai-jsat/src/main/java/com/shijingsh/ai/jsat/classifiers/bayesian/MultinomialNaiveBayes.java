...
package com.shijingsh.ai.jsat.classifiers.bayesian;
...
import com.shijingsh.ai.jsat.math.MathTricks;
 ...
 * {@link #train(ClassificationDataSet) } but
 * not after {@link #update(DataPoint, int) }
 *
 * @author Edward Raff
 */
public class MultinomialNaiveBayes extends BaseUpdateableClassifier implements Parameterized {
     ...
     * {@link #train(ClassificationDataSet) }.
