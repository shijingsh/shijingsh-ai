...
import com.shijingsh.ai.jsat.classifiers.evaluation.Accuracy;
import com.shijingsh.ai.jsat.classifiers.evaluation.ClassificationScore;
...
import com.shijingsh.ai.jsat.regression.evaluation.MeanSquaredError;
import com.shijingsh.ai.jsat.regression.evaluation.RegressionScore;
...
abstract public class ModelSearch implements Classifier, Regressor {
     ...
     * {@link Classifier#train(ClassificationDataSet, java.util.concurrent.ExecutorService) }
     * and
     * {@link Regressor#train(RegressionDataSet, java.util.concurrent.ExecutorService) }
     * methods.<br>
     * <br>
     ...
     *         {@link #train(RegressionDataSet, java.util.concurrent.ExecutorService) },
