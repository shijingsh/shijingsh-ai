...
import static com.shijingsh.ai.jsat.linear.RowColumnOps.addMultCol;
import static com.shijingsh.ai.jsat.linear.RowColumnOps.divCol;
import static com.shijingsh.ai.jsat.linear.RowColumnOps.multCol;
import static com.shijingsh.ai.jsat.linear.RowColumnOps.swapCol;
        ...
        while (p > 0 && iter < maxIterations) {
            ...
            case 4: {
                ...
                if (s[k] <= 0.0) {
                    ...
                    RowColumnOps.multCol(V, k, 0, pp + 1, -1);
                }
                ...
                while (k < pp) {
                    ...
                    if (k < n - 1)
                        RowColumnOps.swapCol(V, k, k + 1, 0, n);
                    if (k < m - 1)
                        RowColumnOps.swapCol(U, k, k + 1, 0, m);
