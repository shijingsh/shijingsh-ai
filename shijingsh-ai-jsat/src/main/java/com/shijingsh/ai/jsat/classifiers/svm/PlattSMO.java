...
package com.shijingsh.ai.jsat.classifiers.svm;
...
import com.shijingsh.ai.jsat.classifiers.calibration.BinaryScoreClassifier;
...
import com.shijingsh.ai.jsat.distributions.kernels.LinearKernel;
import com.shijingsh.ai.jsat.exceptions.FailedToFitException;
import com.shijingsh.ai.jsat.exceptions.UntrainedModelException;
import com.shijingsh.ai.jsat.linear.ConstantVector;
...
import com.shijingsh.ai.jsat.parameters.Parameter.WarmParameter;
                ...
                if (warmSolution instanceof PlattSMO) {
                    ...
                    if (sameData) {
                        ...
                        for (int i = 0; i < vecs.size(); i++)
                            this.alphas[i] = fuzzyClamp(multiplier * abs(warmSMO.alphas[i]), this.C);
