...
[![Total lines](https://tokei.rs/b1/github/HongZhaoHua/shijingsh-rns?category=lines)](https://tokei.rs/b1/github/HongZhaoHua/shijingsh-rns?category=lines)
...
* [特性](#特性)
* [安装](#安装)
    * [安装shijingsh Core框架](#安装shijingsh-Core框架)
    * [安装shijingsh AI框架](#安装shijingsh-AI框架)
    * [安装shijingsh RNS引擎](#安装shijingsh-RNS引擎)
* [使用](#使用)
    * [设置依赖](#设置依赖)
    * [构建配置器](#构建配置器)
    * [训练与评估模型](#训练与评估模型)
...
* [概念](#概念)
    * [为什么需要信息检索](#为什么需要信息检索)
    * [搜索与推荐的异同](#搜索与推荐的异同)
    * [shijingsh RNS引擎解决什么问题](#shijingsh-RNS引擎解决什么问题)
    * [Ranking任务与Rating任务之间的区别](#Ranking任务与Rating任务之间的区别)
    * [Rating算法能不能用于Ranking问题](#Rating算法能不能用于Ranking问题)
* [示例](#示例)
    * [shijingsh RNS引擎与Groovy脚本交互](#shijingsh-RNS引擎与Groovy脚本交互)
    * [shijingsh RNS引擎与JS脚本交互](#shijingsh-RNS引擎与JS脚本交互)
    * [shijingsh RNS引擎与Lua脚本交互](#shijingsh-RNS引擎与Lua脚本交互)
    * [shijingsh RNS引擎与Python脚本交互](#shijingsh-RNS引擎与Python脚本交互)
* [对比](#对比)
* [版本](#版本)
* [参考](#参考)
    * [个性化模型](#个性化模型)
...
**shijingsh RNS是一个面向信息检索领域的轻量级引擎.遵循Apache 2.0协议.**
...
* 1.跨平台
* [2.串行与并行计算](https://github.com/HongZhaoHua/shijingsh-ai)
* [3.CPU与GPU硬件加速](https://github.com/HongZhaoHua/shijingsh-ai)
* [4.模型保存与装载](https://github.com/HongZhaoHua/shijingsh-ai)
* 5.丰富的推荐与搜索算法
* 6.丰富的脚本支持
    * Groovy
    * JS
...
```shell
git clone https://github.com/HongZhaoHua/shijingsh-core.git
...
```shell
git clone https://github.com/HongZhaoHua/shijingsh-ai.git
...
```shell
git clone https://github.com/HongZhaoHua/shijingsh-rns.git
...
```gradle
compile group: 'com.shijingsh', name: 'rns', version: '1.0'
```
...
#### shijingsh-RNS引擎解决什么问题

```
shijingsh-RNS引擎旨在解决推荐与搜索领域的两个核心任务:排序预测(Ranking)和评分预测(Rating).
```
...
#### shijingsh-RNS引擎与Groovy脚本交互

* [完整示例](https://github.com/HongZhaoHua/shijingsh-rns/tree/master/src/test/java/com/shijingsh/rns/script)
...
* 使用shijingsh框架从Model.groovy文件加载并执行Groovy脚本
...
* 使用shijingsh框架从Model.js文件加载并执行JS脚本
...
* 使用shijingsh框架从Model.lua文件加载并执行Lua脚本
...
* 使用shijingsh框架从Model.py文件加载并执行Python脚本
...
shijingsh RNS遵循[Apache 2.0协议](https://www.apache.org/licenses/LICENSE-2.0.html),一切以其为基础的衍生作品均属于衍生作品的作者.
